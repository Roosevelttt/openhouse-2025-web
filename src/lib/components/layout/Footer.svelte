		...
		>
			...
			<div class="flex justify-center md:justify-start">
				<div class="flex flex-col items-center gap-4 font-semibold md:items-start">
					...
					>
						<img
							src="/svg/logo/instagram-icon.svg"
							alt="Instagram Icon"
							class="h-4 w-4 transition-transform group-hover:scale-110"
						/>
						<span
							class="font-lexend text-md text-[var(--color-light-gold)] opacity-90 transition-opacity group-hover:opacity-100"
							>openhouse.pcu</span
						>
					</a>
					<a
						href="https://line.me/R/ti/p/@001pyqes"
						target="_blank"
						rel="noopener noreferrer"
						class="group flex items-center gap-3"
					>
						<img
							src="/svg/logo/line-icon.svg"
							alt="Line Icon"
							class="h-4 w-4 transition-transform group-hover:scale-110"
						/>
						<span
